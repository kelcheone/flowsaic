...
const CustomEdgeModule: FC<EdgeProps> = (props) => {
  const {
    id,
    sourceX,
    sourceY,
  ...
  const flowSetEdges = useModuleFlowStore((state) => state.setEdges);
  const deleteEdge = useModuleFlowStore((state) => state.deleteEdge);
...
export default CustomEdgeModule;
